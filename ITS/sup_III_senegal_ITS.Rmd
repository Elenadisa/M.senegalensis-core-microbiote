---
title: "Senegal (Understory vs Gap) Analysis ITS"
...
In this analysis we want to analyse the differences and similarities in microbiota composition between Understory and Gap soil conditions in Senegal.
...
```{r AbundancePerSampleHeatmapGenusAllSamples, fig.height = 8, fig.width = 8, fig.cap="Heatmap comparing abundance of genera across experimental groups.Color gradients represents the abundance. Each row corresponds to a genus, while each column represents a sample grouped by experimental condition."}
...
If we analyse the genera that are within all the samples in Spain and Senegal under the tree (see supplementary file II), we found that Chaetomiaceae, Aspergillus, Agaricus, and Cladosporium are more abundant under Understory condition, whereas, Pleosporales and Alternaria are more abundant under Gap condition.  
...
With this analysis we have found that Cladosporium is more abundant under Understory condition, whereas, Pleosporales, Phaeosphaeriaceae, and Alternaria are more abundant under Gap condition.  
...
```{r AbundancePerSampleHeatmapGenus-1Samples, fig.height=9, fig.width=8, fig.cap="Heatmap comparing abundance of genera across experimental groups. Color gradients represents the abundance. Each row corresponds to a genus, while each column represents a sample grouped by experimental condition."}
...
```{r AbundanceHeatmapGenus-1Samples, fig.height=9, fig.cap="Heatmap comparing abundance of genera across experimental groups. Color gradients represents the abundance. Each row corresponds to a Genus, while each column represents an experimental group, facilitating the comparison of genus distribution and abundance patterns across groups."}
...
If we analyse the genera that are within all the samples in Spain and Senegal under the tree (see supplementary file II), Aspergillus, Chaetomiaceae, Cladosporium and Agaricus are significantly more abundant in Understory condition whereas, Pleosporales is significantly more abundant under Gap condition. 
...
With this analysis we have found some genera more abundant under Gap condition (Pleosporales, Phaeosphaeriaceae, Hypocrealles and Alternaria) or under Understory condition (Cladosporium).
